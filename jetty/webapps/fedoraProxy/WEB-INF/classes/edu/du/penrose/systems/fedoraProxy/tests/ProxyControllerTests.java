...
//				
		client.getState().setCredentials(
				new AuthScope( "lib-ram.cair.du.edu", 7080, null ),
				new UsernamePasswordCredentials( "specialCollections", "specialPW128Rt" ));
		
		client.getState().setCredentials(
				new AuthScope( "digitaldu.coalliance.org", 80, null ),
				new UsernamePasswordCredentials( "specialCollections", "specialPW128Rt" ));
